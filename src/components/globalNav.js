  ...
  render() {
    ...
    nav.innerHTML = `
      ...
      <div class="global-nav-fab-container">
        ...
        <span class="global-nav-fab-label">Add</span>
      </div>

      <!-- Search (FAB) -->
      <div class="global-nav-fab-container">
        <button class="global-nav-fab search-fab" id="globalNavSearch" aria-label="Search" aria-haspopup="true">
          ${ICONS.search}
        </button>
        <span class="global-nav-fab-label">Search</span>
      </div>
